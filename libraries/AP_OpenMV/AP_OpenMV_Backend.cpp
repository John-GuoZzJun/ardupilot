...
bool AP_OpenMV_Backend::init_serial_port()
{
    if (!hal.scheduler->thread_create(
            FUNCTOR_BIND_MEMBER(&AP_OpenMV_Backend::loop, void),
            "FrSky",
            1024,
 ...
 */
void AP_OpenMV_Backend::loop(void)
{
 ...
 */
float AP_OpenMV_Backend::get_vspeed_ms(void)
{
 ...
 * for FrSky D and SPort protocols
 */
void AP_OpenMV_Backend::calc_nav_alt(void)
{
 ...
 * for FrSky D and SPort protocols
 */
float AP_OpenMV_Backend::format_gps(float dec)
{
 ...
 * for FrSky D and SPort protocols
 */
void AP_OpenMV_Backend::calc_gps_position(void)
{
    AP_AHRS &_ahrs = AP::ahrs();
 ...
 * for FrSky D and SPort protocols
 */
bool AP_OpenMV_Backend::calc_rpm(const uint8_t instance, int32_t &value) const
{
#if AP_RPM_ENABLED
